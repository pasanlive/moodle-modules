...
function pasantest_add_instance(stdClass $pasantest, mod_pasantest_mod_form $mform = null) {
    ...
    return $DB->insert_record('pasantest', $pasantest);
}
...
function pasantest_update_instance(stdClass $pasantest, mod_pasantest_mod_form $mform = null) {
    ...
    return $DB->update_record('pasantest', $pasantest);
}
...
function pasantest_delete_instance($id) {
    ...
    if (! $pasantest = $DB->get_record('pasantest', array('id' => $id))) {
        return false;
    }

    # Delete any dependent records here #

    $DB->delete_records('pasantest', array('id' => $pasantest->id));
...
function pasantest_scale_used_anywhere($scaleid) {
    ...
    /** @example */
    if ($scaleid and $DB->record_exists('pasantest', array('grade' => -$scaleid))) {
        return true;
    } else {
        return false;
    }
...
function pasantest_grade_item_update(stdClass $pasantest, $grades=null) {
    ...
    grade_update('mod/pasantest', $pasantest->course, 'mod', 'pasantest', $pasantest->id, 0, null, $item);
}
...
function pasantest_update_grades(stdClass $pasantest, $userid = 0) {
    ...
    grade_update('mod/pasantest', $pasantest->course, 'mod', 'pasantest', $pasantest->id, 0, $grades);
}
